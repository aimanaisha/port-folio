...
const Nav = () => {
    return ( <div className="hidden md:block bg-[#0A0E13] h-screen w-56  flex flex-col items-center">
        <div className="font-monoton text-8xl text-[#621AD7] h-44 border-b-2 border-[#444242] w-full justify-center flex items-center">
            <Link className="magic-hover magic-hover__square" href="/">A</Link>
        </div>

        <div className="font-fira text-[#7F7F7F] text-2xl w-full  flex flex-col justify-evenly text-center ">
