...
<div className="netflix-nav netflix-nav-black">
	<div className="netflix-nav netflix-nav-red">
		<div className="netflix-nav netflix-nav-white">
			...
			<button className="netflix-nav-btn netflix-close-btn text-[#B8B6B6]"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
