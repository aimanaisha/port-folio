const Contact = () => {
  return (
    <div className="w-full flex flex-col justify-between pt-20 pl-20 pb-4">
      ...
      <div className="flex mt-16 flex-row ml-10 font-fira text-[#B8B6B6]">
        
          <div className=" border-4 mx-10 h-40 w-40 border-[#621AD7] rounded-full flex justify-center flex-col items-center">
            <h4> &#60; &#62; </h4>
            <h4> Instagram </h4>
            <h4> &#60;/&#62; </h4>
          </div>
          <div className="border-4 mx-10 mt-44 h-32 w-32 border-[#621AD7] rounded-full flex justify-center flex-col items-center">
            <h4> &#60; &#62; </h4>
            <h4> Facebook </h4>
            <h4> &#60;/&#62;</h4>
          </div>        
